...
public class FindApplicantsTesting {
	...
	@Test
	public void findApplicantsWithoutLogin() {
		JSONObject json = new JSONObject();
		
		json.put("keywords", "Java developer");
		JSONObject result = WebTestHelper.request("http://localhost:4567/findApplicants", json);
	...
	@Test
	public void findApplicantsAfterLoginAsStudent() {
		fail("Not yet implemented");
	}
	
	@Test
	public void findSpecialApplicantsAfterLoginAsStudent() {
		fail("Not yet implemented");
	}
